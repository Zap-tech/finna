...
return (new CustomEvent(event_name,(function (){var obj31998 = ({"detail":data});
return obj31998;
})()));
} else {
...
var f = (function (){var pred__32005 = cljs.core._EQ_;
var expr__32006 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__32005.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__32006))){
return ((function (pred__32005,expr__32006){
return (function (p1__31999_SHARP_){
return console.warn(p1__31999_SHARP_);
});
;})(pred__32005,expr__32006))
} else {
if(cljs.core.truth_(pred__32005.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__32006))){
return ((function (pred__32005,expr__32006){
return (function (p1__32000_SHARP_){
return console.debug(p1__32000_SHARP_);
});
;})(pred__32005,expr__32006))
} else {
if(cljs.core.truth_(pred__32005.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__32006))){
return ((function (pred__32005,expr__32006){
return (function (p1__32001_SHARP_){
return console.error(p1__32001_SHARP_);
});
;})(pred__32005,expr__32006))
} else {
return ((function (pred__32005,expr__32006){
return (function (p1__32002_SHARP_){
return console.log(p1__32002_SHARP_);
});
;})(pred__32005,expr__32006))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__32009){
...
var eval_fn = cljs.core.get.call(null,map__32010__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__32012_SHARP_);
});})(new_def))
);
...
return (function (p__32013){
var vec__32014 = p__32013;
var ky = cljs.core.nth.call(null,vec__32014,(0),null);
var v = cljs.core.nth.call(null,vec__32014,(1),null);
...
}catch (e32019){if((e32019 instanceof Error)){
var e = e32019;
return not_found;
} else {
throw e32019;
...
//# sourceMappingURL=utils.js.map?rel=1572042001105
